...
INSERT INTO users(email, username, profile_pic, firstname, lastname, password,  gender, last_online, verified, user_type) VALUES ('admin@matcha.com', 'Tristyn', 'default.jpg', 'Tristyn', 'Spies', '$2b$12$T/ENjvPLY4p.beWVlWjGOe/6j0h2agDbFYA.Hub9DilAKzExtkJeq', 'Male', 'Never', 1, 'admin');
